...
def main(file_name: str, progress_tracker=None):
    ...
    def save_try(wb, file_path, current_step_tracker, current_step_count):
        # try:
        wb.save(file_path)
        ...
        #     save_try(wb, file_path, current_step_tracker, current_step_count)
        # except Exception as e:
        #     print(f"Ошибка при сохранении файла: {e}")
        #     print('jkldasjkl;dsajhdsajksadjkdashjsadhjdsahjdsajhsdahkhdsahnz,xcmn')
        #     raise

    save_try(wb, file_path, progress_tracker, current_step)
